...
def initialize_fluxes(z, Q, T=5.0, S=25.0, W=100.0, α=0.1, Sp=1e-8, ρ_0=1025.0, g=-9.81, lat=60.0) -> tuple:
...
def plume(z, Q, dz, z_max=-1, T=5.0, S=25.0, W=100.0, α=0.1, Sp=1e-8, ρ_0=1025.0, g=-9.81, lat=60.0) -> tuple:
